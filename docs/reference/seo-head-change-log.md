...
- EN area-page breadcrumb references no longer point to `https://fixera.net/index.html`
...
- `blog/handyhand-vs-fixera.html` now has aligned head fields and `BlogPosting` structured data
